...
def writer_prompt(
    *,
    ...
    return (
        ...
        "If at least one such threshold exists, stop there — do not also add a sentence about "
        "missing thresholds; the cited ones already answer the section. Only when NO threshold "
        "anywhere in the notes was actually measured, say so once in your own words, under "
        "Empirical cutoffs only — never as a second, separate line under Engineering heuristics. "
